...
export default function CanvasLight() {
    useEffect(() => {
        const debounce = (callback: (event: any) => void, duration: number) => {
        ...
        class Butterfly {
            ...
            >;
            constructor(i: number, texture: THREE.Texture) {
                this.uniforms = {
                    index: {
                        type: "f",
                        value: i,
        ...
        const texture = bgloader.load(
            "https://media.istockphoto.com/id/1168092599/photo/sunshine-clouds-sky-during-morning-background-blue-white-pastel-heaven-soft-focus-lens-flare.webp?b=1&s=170667a&w=0&k=20&c=lH_Zl3mfi8VAhZt-WBsKism0bjOYjkDCX82o_HT2n7g="
        );
